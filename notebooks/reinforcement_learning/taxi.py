...
# %%
def epsilon_greedy(Q: np.ndarray, state, epsilon: float, i: int, j: int):
...
with imageio.get_writer(buffer, format="gif", fps=2, loop=0) as writer:  # ty: ignore invalid-argument-type
    for frame in frames:
