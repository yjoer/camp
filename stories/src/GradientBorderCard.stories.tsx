...
function GradientBorderCard({ image }: GradientBorderCardProps) {
  return (
    <div className="w-64">
      <div className="relative overflow-hidden rounded-xl border-1 border-white/4">
        <img
          alt=""
        ...
        />
        <div
          className="mask-clip-[content-box,border-box] pointer-events-none absolute inset-0
            rounded-[11px] bg-[linear-gradient(180deg,rgb(255_255_255/16%),rgb(255_255_255/2%))]
            mask-[linear-gradient(#fff_0_0),linear-gradient(#fff_0_0)] mask-exclude p-[1px]"></div>
      </div>
